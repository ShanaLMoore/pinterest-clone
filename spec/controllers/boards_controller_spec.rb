...
RSpec.describe BoardsController do
  ...
  after(:each) do
    ...
    pins = Pin.where("title=?","Rails Cheatsheet")
    pins.each do |pin|
      pin.destroy
    end
  ...
  describe "POST create" do
    ...
    it 'creates a board' do
      post :create, board: @board_hash
      expect(Board.find_by_name("My Pins!").present?).to eq(true)
    end
  ...
  describe "GET #edit" do
    ...
    it 'assigns an instance variable to a existing board' do
      get :edit, id: @board.id, followers: @user.user_followers
    ...
    it 'sets @follower to the user\'s followers' do
      get :edit, id: @board.id, followers: @user.user_followers
  ...
  describe "PUT #update" do
    ...
    it 'redisplays edit from on error' do
      # The name is required in the Board model, so we'll
    ...
    it 'creates a BoardPinning' do
      ...
      # We get the user's first follower - this is the one we want to let pin
      # on @board
      ...
      @board_hash[:board_pinners_attributes] << {user_id: user_to_let_pin.user_id}
      put :update, id: @board.id, board: @board_hash
  ...
  describe "GET #show" do
    ...
    it "assigns the @pin variable with the board's pins" do
      get :show, id: @board
