...
# This spec was generated by rspec-spec when you ran the scaffold generator.
# It demonstrates how one might use RSpec to specify the controller code that
# was generated by spec when you ran the scaffold generator.
#
# It assumes that the implementation code is generated by the spec scaffold
# generator.  If you are using any extension libraries to generate different
# controller code, this generated spec may or may not pass.
#
# It only uses APIs available in spec and/or rspec-spec.  There are a number
# of tools you can use to make these specs even more expressive, but we're
# sticking to spec and rspec-spec APIs to keep things simple and stable.
#
